...
namespace cmp {
    ...
    [[nodiscard]] double tol(Tolerance t = default_tolerance) noexcept;
    [[nodiscard]] bool near(double lhs, double rhs,
                            Tolerance t = default_tolerance) noexcept;

    [[nodiscard]] bool zero(double lhs,
                            Tolerance t = default_tolerance) noexcept;

    [[nodiscard]] bool le(double lhs, double rhs,
                          Tolerance t = default_tolerance) noexcept;
    [[nodiscard]] bool ge(double lhs, double rhs,
                          Tolerance t = default_tolerance) noexcept;
} // namespace cmp
